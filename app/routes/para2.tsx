              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm opacity-70 font-medium leading-relaxed">
                    Australian compliance and risk mitigation at enterprise
                    scale.
                  </p>
                </div>
              </motion.div>
          ...
          <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-20 items-center">
            ...
            >
              ...
              <p className="text-xl text-gray-400 font-medium leading-relaxed mb-12">
                ...
                presence. From high-level LinkedIn thought leadership to your
                core platform, your voice remains singular.
              </p>
