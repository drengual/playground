        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
            <div className="max-w-xl">
              <h2 className="text-5xl font-bold mb-6 italic">Core Expertise</h2>
          ...
          <div className="grid md:grid-cols-3 gap-0 border border-gray-100 rounded-[3rem] overflow-hidden shadow-sm font-sans">
            {[
              ...
              <motion.div
                key={i}
                whileHover={{ backgroundColor: colors.navy, color: "#FFFFFF" }}
        ...
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-20 items-center">
          ...
          <div className="order-1 md:order-2">
            ...
            <p className="text-xl text-gray-300 font-sans leading-relaxed mb-10">
              ...
              first click on LinkedIn to the final consultation, we ensure your
              brand speaks with one, focused voice.
            </p>
