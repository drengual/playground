...
const BackButton = () => (
  <Link
    to="/"
    className="fixed top-6 left-6 z-[100] px-5 py-3 bg-white/90 backdrop-blur-md rounded-full shadow-lg hover:shadow-xl transition-all flex items-center gap-2 text-sm font-bold uppercase tracking-wider text-[#2D3436] hover:bg-[#2D3436] hover:text-white group"
  >
    <svg
            ...
            <div className="grid lg:grid-cols-2 gap-24 items-start">
              ...
              <div className="space-y-12">
                <p className="text-lg text-gray-500 leading-relaxed font-light">
                  In the Australian market, agility is often confused with
                  chaos. Parachute brings the rigorous oversight of tier-one
                  consulting with the speed and bespoke touch of a boutique
                  firm.
                </p>
            ...
            <div className="grid lg:grid-cols-2 gap-24 items-center">
              ...
              <div className="order-1 lg:order-2">
                ...
                <p className="text-lg text-gray-400 leading-relaxed font-light mb-12 max-w-lg">
                  We extend our consulting into the digital sphere, ensuring
                  your personal and corporate brand carries the same structural
                  weight as your balance sheet.
                </p>
